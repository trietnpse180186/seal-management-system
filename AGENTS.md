...
This project is indexed by GitNexus as **seal-management-system** (3509 symbols, 4553 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
