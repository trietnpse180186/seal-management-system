...
This project is indexed by GitNexus as **seal-management-system** (2412 symbols, 3080 relationships, 64 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
