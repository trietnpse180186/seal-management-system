...
This project is indexed by GitNexus as **seal-management-system** (2087 symbols, 2514 relationships, 53 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
