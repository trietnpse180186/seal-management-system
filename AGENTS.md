...
This project is indexed by GitNexus as **seal-management-system** (1871 symbols, 2288 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
