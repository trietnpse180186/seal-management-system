...
This project is indexed by GitNexus as **seal-management-system** (2474 symbols, 3150 relationships, 66 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
