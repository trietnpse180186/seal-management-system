        ...
        <div className="md:col-span-5 space-y-8">
              ...
              {!readOnly && (
                <div className="pt-2 flex flex-col gap-2">
                  ...
                  {selectedEvent?.status === "registration" && (
                    ...
                    >
                      <Lock size={14} />
                      ĐÓNG ĐĂNG KÝ &amp; CHUYỂN BẮT ĐẦU
                    </button>
                  )}
                  {selectedEvent?.status !== "draft" && selectedEvent?.status !== "registration" && (
          ...
          <div className="glass p-5 rounded-2xl border border-slate-800 space-y-4">
            ...
            <div className="space-y-3 font-sans text-xs">
              ...
              <div className="bg-slate-950/60 p-3.5 rounded-xl border border-slate-900 space-y-2">
                <div className="flex justify-between text-[11px]">
                  <span className="text-slate-400">Đội có Repository:</span>
          ...
          {selectedEvent?.status === "ongoing" && !readOnly && (
            <div className="glass p-5 rounded-2xl border border-slate-800 space-y-4 relative overflow-hidden bg-rose-950/5 border-rose-950/30 shadow-[inset_0_0_15px_rgba(244,63,94,0.01)] animate-pulse">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-slate-950/30 p-4 rounded-xl border border-slate-900 text-[11px] text-slate-400 space-y-2">
                    ...
                    <div className="flex gap-2 border-t border-slate-900 pt-2">
                      ...
                      <p>
                        <strong className="text-slate-350">Tiến trình chuẩn:</strong> Đăng ký xong → Đồng bộ Repo → Bắt đầu Vòng thi → Sync &amp; AI Assess → Khóa Vòng (chuyển Scoring) → Tiến cử đội đi tiếp → Kích hoạt vòng thi kế tiếp.
                      </p>
                    </div>
                  </div>
