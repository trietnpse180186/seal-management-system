/**
 * Error Dictionary - Từ điển lỗi tập trung cho Web
 * Ánh xạ HTTP Status Code và Custom Error Codes thành câu thông báo tiếng Việt thân thiện.
 */
const errorMessages: { [key: string]: string } = {
  // --- HTTP Status Codes ---
  "400": 'Yêu cầu không hợp lệ. Vui lòng kiểm tra lại dữ liệu nhập vào.',
  ...
  // --- Mất kết nối mạng ---
  NETWORK_ERROR: 'Không thể kết nối với máy chủ. Vui lòng kiểm tra kết nối mạng của bạn.',

  // --- Lỗi mặc định ---
  DEFAULT_ERROR: 'Đã xảy ra lỗi không xác định. Vui lòng thử lại sau.',

  // --- Ánh xạ các lỗi nghiệp vụ Backend cụ thể ---
